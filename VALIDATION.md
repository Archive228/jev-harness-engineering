...
Новая конфигурация [GitHub Actions](https://github.com/Archive228/jev-harness-engineering/actions) включает Python 3.9, 3.12, 3.13, 3.14 и отдельную сборку HTML. На момент этой записи она ещё не проверена удалённым прогоном; подтверждённый результат текущего кода — локальные 83 теста. Ранее CI на трёх версиях был зелёным: [исторический прогон](https://github.com/Archive228/jev-harness-engineering/actions/runs/35466973846). Он относится к прежнему коммиту.
