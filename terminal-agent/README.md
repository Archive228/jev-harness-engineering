...
1. **Уточнение.** Если результат пока неясен, появляются от одного до трёх вопросов. У вариантов есть короткие объяснения и рекомендация; всегда можно написать свой ответ. Вопросы зависят от запроса и доступного контекста проекта. Ясное задание может сразу перейти к плану.
